...
import com.iobits.budgetexpensemanager.utils.Constants.Companion.ITEM_SKU_REMOVE_ADS_ONLY
...
class AdsManager @Inject constructor(
    ...
    fun showAdLoadingDialog(context: Activity?) {
        ...
        if (alertDialogAds?.getWindow() != null) {
            alertDialogAds?.getWindow()!!.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
        }
    }
    ...
    fun loadNativeAd(
        ...
        if (!preferenceManager.getBoolean(PreferenceManager.Key.IS_APP_ADS_FREE, false)) {
            ...
            builder.forNativeAd { nativeAd: NativeAd ->
                ...
                if (nativeAdView != null) populateUnifiedNativeAdView(
                    nativeAd,
                    nativeAdView,
                    nativeAdViewType,
                    activity,
    ...
    private fun populateUnifiedNativeAdView(
        ...
        // Set the media view.
        if (nativeAdType == NativeAdType.REGULAR_TYPE || nativeAdType == NativeAdType.MEDIUM_TYPE) adView.mediaView =
        ...
        if (nativeAdType == NativeAdType.REGULAR_TYPE || nativeAdType == NativeAdType.MEDIUM_TYPE) adView.mediaView!!.mediaContent =
